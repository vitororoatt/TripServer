...
@trips_routs_bp.route("/trips/<tripId>" , methods = ["GET"])
...
@trips_routs_bp.route("/trips/<tripId>/confirm" , methods = ["GET"])
...
@trips_routs_bp.route("/trips/<tripId>/links" , methods = ["POST"])
...
@trips_routs_bp.route("/trips/<tripId>/links" , methods = ["GET"])
...
@trips_routs_bp.route("/trips/<tripId>/invites" , methods = ["POST"])
...
@trips_routs_bp.route("/trips/<tripId>/activities" , methods = ["POST"])
def create_activitiy(tripId):
    conn = db_connection_handler.get_connection()
...
@trips_routs_bp.route("/trips/<tripId>/participants" , methods = ["GET"])
...
@trips_routs_bp.route("/trips/<tripId>/activities" , methods = ["GET"])
...
@trips_routs_bp.route("/participants/<participantId>/confirm" , methods = ["PATCH"])
